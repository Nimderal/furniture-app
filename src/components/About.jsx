...
import cardsData from "./data2.jsx";
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="font-semibold leading-7 text-5xl text-indigo-600">Latest Products</h2>
        
        </div>
        <div className="flex mt-16 w-full flex-wrap">
          {/* Map over the cardsData array to generate cards dynamically */}
          {cardsData.map((card, index) => (
            <div key={index} className="relative m-10 flex w-full max-w-xs flex-col flex-nowrap overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
